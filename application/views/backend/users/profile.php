    ...
    <div class="row">
  		<div class="col-sm-5 col-md-6>"><!--left col-->
		    <div class="text-center">
         	...
         	<ul class="list-group">
	            <li class="list-group-item"><span><strong>POSTS </strong></span>
	            	<strong class="float-right text-info"> <?php echo $getCountPost->n; ?></strong>
	            </li>
              <li class="list-group-item"><span ><strong>comments </strong></span>
                <strong class="float-right text-info"> <?php echo $getCountPost->n; ?></strong>
              </li>
          	</ul> 
        </div><!--/col-3-->
