...
class Users extends CI_Controller
{
	...
	// 		//encrypt password
	// 		$enc_pwd = md5($this->input->post('pwd'));
	// 		$data = array(
	// 			'name' =>$this->input->post('name'),
	...
	// this function is call by ajax in header in the view
    ...
    {  
           ...
           {  
           	// print_r($_POST);die();
                echo '<h6 class="text-danger"><span class="glyphicon glyphicon-remove"></span> Invalid Email</span></h6>';  
           }  
           else  
           {  
                ...
                if($this->user_model->check_email_exist($email))  
                {  
                     echo '<h6 class="text-danger"><span class="glyphicon glyphicon-remove"></span> Email Already register</h6>';  
                }  
                else  
                {  
                     echo '<h6 class="text-success"><span class="glyphicon glyphicon-ok"></span> Email Available</h6>';  
                }  
           }  
      }  
     function username_is_exist()
    {
    	...
    	if(!$username)
    	{
    		echo '<h6 class="text-danger"><span class="glyphicon glyphicon-remove"></span> Invalid Username</span></h6>';
    	}
    	else
    	{
    		if ($this->user_model->check_username_exist($username)) 
    		{
    			echo '<h6 class="text-danger"><span class="glyphicon glyphicon-remove"></span> Username Already register</h6>';
    		}
    		else
    		{
    			echo '<h6 class="text-success"><span class="glyphicon glyphicon-ok"></span> Username Available</h6>'; 
    		}
    	}
    }
